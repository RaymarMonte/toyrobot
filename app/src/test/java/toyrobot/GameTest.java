...
public class GameTest extends SysOutTest {
    ...
    @Test void gameCanPlaceInsideBoard() {
        Game game = new Game(reporter);
        game.place(new CoordinatesFacingADirection(0, 0, Direction.NORTH));
        game.report();
    ...
    @Test void gameCanMoveAfterPlace() {
        Game game = new Game(reporter);
        game.place(new CoordinatesFacingADirection(1, 1, Direction.EAST));
        game.move();
        game.report();
    ...
    @Test void gameCanLeftAfterPlace() {
        Game game = new Game(reporter);
        game.place(new CoordinatesFacingADirection(2, 2, Direction.SOUTH));
        game.left();
        game.report();
    ...
    @Test void gameCanRightAfterPlace() {
        Game game = new Game(reporter);
        game.place(new CoordinatesFacingADirection(3, 3, Direction.WEST));
        game.right();
        game.report();
    ...
    @Test void gameCanReportAfterPlace() {
        Game game = new Game(reporter);
        game.place(new CoordinatesFacingADirection(4, 4, Direction.NORTH));
        game.report();
    ...
    @Test void gameCantPlaceOutsideBoardDimensions() {
        Game game = new Game(reporter);
        game.place(new CoordinatesFacingADirection(5, 5, Direction.EAST));
        game.report();
        assertEquals("".trim(), outContent.toString().trim());
    }
    ...
    @Test void gameCantMoveOutsideBoardDimensions() {
        Game game = new Game(reporter);
        game.place(new CoordinatesFacingADirection(0, 0, Direction.SOUTH));
        game.move();
        game.report();
